...
export default ({url, text}) => {
  ...
  return (
    <div>
      <a className='resp-sharing-button__link' href={`mailto:?subject=${safeText}&body=${safeUrl}`} target='_blank' aria-label='E-Mail'>
      ...
      <a className='resp-sharing-button__link' href={`https://facebook.com/sharer/sharer.php?u=${safeUrl}`} target='_blank' aria-label='Facebook'>
      ...
      <a className='resp-sharing-button__link' href={`https://twitter.com/intent/tweet/?text=${safeText}&url=${safeUrl}`} target='_blank' aria-label='Twitter'>
      ...
      <a className='resp-sharing-button__link' href={`https://plus.google.com/share?url=${safeUrl}`} target='_blank' aria-label='Google+'>
        <div className='resp-sharing-button resp-sharing-button--google resp-sharing-button--medium'><div aria-hidden='true' className='resp-sharing-button__icon resp-sharing-button__icon--solid'>
      ...
      <a className='resp-sharing-button__link' href={`https://www.linkedin.com/shareArticle?mini=true&url=${safeUrl}&title=${safeText}&summary=${safeText}&source=${safeUrl}`} target='_blank' aria-label='LinkedIn'>
